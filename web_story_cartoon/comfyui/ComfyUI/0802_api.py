...
def main():
    ...
    with torch.inference_mode():
        ...
        cliptextencode_6 = cliptextencode.encode(
            text="(cartoon) A young woman named Jin-sook stares glumly at a subway fare card reader, pulling out crumpled bills.",
            clip=get_value_at_index(checkpointloadersimple_4, 1),
        )

        cliptextencode_7 = cliptextencode.encode(
            text="text, watermark, low quality, worst quality, extra hands, extra hand, japan, china ugly, extra limb, ugly eyes",
            clip=get_value_at_index(checkpointloadersimple_4, 1),
        )
